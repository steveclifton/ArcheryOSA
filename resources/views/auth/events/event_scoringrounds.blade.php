                            ...
                            <div class=" table-condensed table-striped table-responsive">
                                ...
                                <table class="table">
                                    ...
                                    @foreach($users as $user)
                                        @if($user->eventroundid !== $eventround->eventroundid)
                                            @continue
                                        @endif
                                        <tr>
                                            <td class="hidden">
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="total[{{$user->evententryid}}][total]" data-id="total-{!! md5($user->evententryid . $user->divisionname) !!}" data-usertotal="{!! md5($user->evententryid . $user->divisionname) !!}" value="{{ old("total.$user->evententryid.total") ?? $user->result->total_score ?? ''}}">
                                            </td>
